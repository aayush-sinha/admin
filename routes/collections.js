...
// This file contains the logic of every route in Forest Admin for the collection collections:
...
// Get a Collection
router.get('/collections/:recordId(?!count)', permissionMiddlewareCreator.details(), (request, response, next) => {
